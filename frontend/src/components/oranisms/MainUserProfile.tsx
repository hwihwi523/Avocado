    ...
    <>
      ...
      >
        <TextDiv>
            ...
            <br/>
            <Typography variant="subtitle2" fontWeight={"bold"}>{mbti}</Typography>
        </TextDiv>
        <TextDiv>
            <StyledTitle>Color</StyledTitle>
            <br/>
            <Typography variant="subtitle2" fontWeight={"bold"}>{personalcolor.name}<br/>{personalcolor.type}</Typography>
        </TextDiv><TextDiv>
            <StyledTitle>Grade</StyledTitle>
            <br/>
            <Typography variant="subtitle2" fontWeight={"bold"}>1.LV</Typography>
        </TextDiv>
      </Stack>
