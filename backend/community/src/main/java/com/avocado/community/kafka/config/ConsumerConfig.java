package com.avocado.community.kafka.config;
...
public class ConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MemberEvent> purchaseHistoryKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MemberEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(memberEventConsumerFactory("community-group-testing-1"));
//        factory.setConsumerFactory(memberEventConsumerFactory("community-group"));
