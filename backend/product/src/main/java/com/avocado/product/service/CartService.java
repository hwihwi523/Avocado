...
public class CartService {
     ...
     * 장바구니 내역 삭제
     * @param consumerId : 요청한 소비자의 ID
     * @param merchandiseId : 삭제 요청한 상품의 ID
     */
    public void removeProductFromCart(UUID consumerId, Long merchandiseId) {
        // 장바구니 내역 찾기
        Cart cart = cartRepository.findByConsumerIdAndMerchandiseId(consumerId, merchandiseId);
        if (cart == null)
