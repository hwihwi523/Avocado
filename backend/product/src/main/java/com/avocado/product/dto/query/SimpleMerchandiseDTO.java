...
public class SimpleMerchandiseDTO {
    ...
    @QueryProjection
    public SimpleMerchandiseDTO(Long id, String brandName, Long merchandiseId, String merchandiseCategory, String merchandiseName,
                                Integer price, Integer discountedPrice, Float score) {
        this.id = id;
