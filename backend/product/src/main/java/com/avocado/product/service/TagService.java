...
public class TagService {
    ...
    public void updateAll() {
        ...
        List<MaxMbtiDTO> mbtis = scoreRepository.findMbtis();
        List<MaxPersonalColorDTO> personalColors = scoreRepository.findPersonalColors();
        List<MaxAgeGroupDTO> ageGroups = scoreRepository.findAges();
